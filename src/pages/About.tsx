  ...
  return (
    <section className="mx-auto max-w-4xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <p className="text-lg leading-8 text-white/75">
        The goal is to create a platform where audiences can discover music, watch visual
        projects, connect with the story behind the art, and shop curated releases.
      </p>
    </section>
  );
}